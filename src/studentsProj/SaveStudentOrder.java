...
import studentsProj.dao.DictionaryDaoImpl;
import studentsProj.dao.StudentOrderDao;
import studentsProj.dao.StudentOrderDaoImpl;
...
//        System.out.println(ans);
    ...
    static long saveStudentOrder(StudentOrder studentOrder){
        long answer = 199;
        System.out.println("Student save order: ");
        return answer;
    }
    ...
    public static StudentOrder buildStudentOrder(long id){
        ...
        husband.setIssueDepartment(po1); // 1, "Police department № " + id
        ...
        //Child_2
        Child child2 = new Child("Petrov", "Evgeni","Viktorovich", LocalDate.of(2018,6,29));
